...
def build_training():
    ...
    ov=cards([
        ...
        {'t':'福盛世家添翼版 G24','d':'2.0% 固定增额终身寿。利益确定写入合同，3 年交 4 年回本，含特定公共交通意外险。','pill':'固定2% · 确定给付'},
    ...
    ov+=tbl(['产品','代码','男最高投保年龄(趸/3/5/10年)','女最高投保年龄','3年交起售','产品形态与特点'],
        [['宏泰世家（分红增额终身寿）','S03','64/63/62/60','67/67/66/64','3万','三年交5年覆盖总保费；1.2%分红稳健；同档现价靠前'],
         ...
         ['福盛世家添翼版（2.0%固定增额）','G24','68/68/67/65','72/72/70/65','2万','固定2%增额；3年交4年回本；含特定公共交通意外险'],
    ...
    s.append(sec('fusheng','🌿','福盛世家添翼版（固定增额）','G24 · 2.0% 固定增额终身寿',fs))
    # 宏愿
